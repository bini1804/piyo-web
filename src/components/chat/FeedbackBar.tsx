        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            style={{
              ...
              borderRadius: "999px",
              border: feedback === 1 ? "none" : "1px solid #e5e5e5",
              background: feedback === 1 ? "#F4CB4B" : "white",
          ...
          <button
            ...
            style={{
              ...
              justifyContent: "center",
              borderRadius: "999px",
              border: feedback === -1 ? "1px solid #d0d0d0" : "1px solid #e5e5e5",
              background: feedback === -1 ? "#f0f0ee" : "white",
              cursor: submitted ? "default" : "pointer",
              transition: "all 0.2s",
              opacity: submitted && feedback !== -1 ? 0.3 : 1,
            }}
